...
void FJScriptEditorPlugin::StartupModule()
{
	...
	// Register LevelEditor Toolbar
	FJScriptPluginCommands::Register();
	ToolbarExtender = MakeShareable(new FExtender);
	ToolbarExtension = ToolbarExtender->AddToolBarExtension("Compile", EExtensionHook::After, FJScriptPluginCommands::Get().UIActions, FToolBarExtensionDelegate::CreateStatic(&FJScriptPluginCommands::AddToolbarExtension));
...
{
	FJScriptPluginCommands::Unregister();
